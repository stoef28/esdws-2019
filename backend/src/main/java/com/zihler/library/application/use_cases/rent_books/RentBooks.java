...
import com.zihler.library.LibraryResource;
...
public class RentBooks {
    ...
    public List<String> executeWith(String customerName, List<RentBookRequest> rentBookRequests, RestRentalRecordPresenter presenter) {
